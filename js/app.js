...
while (attempts < 3) {
  ...
  //console.log ('I appreciate you\'re pessimism of MJ\'s greatness but not quite that many players have more rings than MJ, guess again');
    ...
    askMike = Number(prompt('Correct! There are nine players with more rings than MJ. So I guess he is the tenth greatest player of all time!'));
    finalScore++;
  }
} if (attempts === 3) {
...
while (attemptsNBA < 5) {
  ...
  for (var i = 0; i < players.length; i++){
    if (NBA === players[i]) {
      ...
      alert('Excellent choice! Pick another player!');
      attemptsNBA = 10;
      finalScore++;
    }
  } if (attemptsNBA !== 10) {
